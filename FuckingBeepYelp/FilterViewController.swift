...
@objc protocol FilterViewControllerDelegate {
    @objc optional func filtersViewController (filersViewController: FilterViewController, didUpdateFilters filters: [String:AnyObject])
}
...
class FilterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate {
    ...
    @IBAction func SearchClick(_ sender: Any) {
        ...
        delegate?.filtersViewController!(filersViewController: self, didUpdateFilters: filters)
    }
    ...
    override func viewDidLoad() {
        ...
        //categoryTable.register(UITableViewCell.self, forCellReuseIdentifier: "filtercell")
        /*checked = [Bool](repeating: false, count: data.count)
        categoryTable.dataSource = self
        categoryTable.delegate = self
        categoryTable.register(UITableViewCell.self, forCellReuseIdentifier: "filtercell")*/
        
        //dropMenu.add(names: ["Thai", "", "why?"])
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "filtercell", for: indexPath) as! SwitchCellTableViewCell
        cell.switcherLabel.text = categories[indexPath.row]["name"]
        
        cell.delegate = self
        
        if switchState[indexPath.row] != nil {
            cell.switcher.isOn = switchState[indexPath.row]!
        } else {
    ...
    func yelpCategory() -> [[String:String]]{
    ...
    func switchCell(switchCell: SwitchCellTableViewCell, didChangeValue value: Bool) {
        let indexPath = categoryTable.indexPath(for: switchCell)!
